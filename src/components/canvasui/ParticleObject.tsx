// @ts-nocheck -- Vendored from https://canvasui.dev/r/particle-object-react.json.
// The particle loops index Float32Arrays directly, which this project's
// `noUncheckedIndexedAccess` flags at 60-odd call sites. Left unedited so the
// file can be re-pulled from the registry; the exported types still check.
"use client";
